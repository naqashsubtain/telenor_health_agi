...
public class GetHealthAssistanFiles extends AbstractBaseAgiScript {
	private final static Logger logger = Logger
			.getLogger(GetHealthAssistanFiles.class);

	public GetHealthAssistanFiles() throws DatabaseException {
		super(true);
	}
	...
	public void service(AgiRequest request, AgiChannel channel)
		...
		try {
			...
			List<Map<String, Object>> result = DBHelper.getInstance().query(
					"SELECT * FROM health_assistant", super.getConnection(),
					new Object[] {});
