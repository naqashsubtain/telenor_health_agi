...
public class CheckFamilyFirstSub extends AbstractBaseAgiScript {
	...
	public void service(AgiRequest request, AgiChannel channel)
		...
		try {
			...
			channel.setVariable("IS_FF_SUB", "NO");
			Map<String, Object> result = DBHelper
					.getInstance()
					.firstRow(
							"select * from family_first_subscriber where cellno = ? AND status = 100",
							super.getConnection(), new Object[] { cellno });
			if (result != null) {
				channel.setVariable("IS_FF_SUB", "YES");
