...
public class SaveHealthAssistantSub extends AbstractBaseAgiScript {
	...
	public void service(AgiRequest request, AgiChannel channel)
		...
		try {
			...
			// "HEALTH_ASSISTANT_SUB", lang);
			// smsSender.sendSMS(msisdn, shortcode,
			// "HEALTH_ASSISTANT_INSTRUCTIONS", lang);
			// }
			//
			// }
			...
			DBHelper.getInstance()
					.executeDml(
							"INSERT INTO health_assistant_subscriber (cellno, sub_date, lang, status) VALUES(?, NOW(), ?, 100) ON DUPLICATE KEY UPDATE status=100,lang=?",
							super.getConnection(),
