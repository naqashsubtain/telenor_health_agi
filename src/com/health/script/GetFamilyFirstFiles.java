...
public class GetFamilyFirstFiles extends AbstractBaseAgiScript {
	private final static Logger logger = Logger
			.getLogger(GetFamilyFirstFiles.class);

	public GetFamilyFirstFiles() throws DatabaseException {
		super(true);
	}
	...
	public void service(AgiRequest request, AgiChannel channel)
		...
		try {
			...
			List<Map<String, Object>> result = DBHelper.getInstance().query(
					"SELECT * FROM family_first", super.getConnection(),
					new Object[] {});
